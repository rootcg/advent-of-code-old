...
class Day4Test {
    ...
    final void exampleSecond() {
        ...
        final Day4 day4 = new Day4();
        Assertions.assertEquals(0, day4.second(invalid.lines().collect(Collectors.toList())));
        Assertions.assertEquals(4, day4.second(valid.lines().collect(Collectors.toList())));
    }
    ...
    final void first() throws IOException {
        ...
        final Day4 day4 = new Day4();
        final long result = day4.first(data);
    ...
    final void second() throws IOException {
        final List<String> data = readInput();
        final Day4 day4 = new Day4();
        final long result = day4.second(data);
        System.out.println("Result is: " + result);
    }
